...
cmake -DCMAKE_TOOLCHAIN_FILE="/opt/MCUXpresso_SDK_2_11_1_MIMX8ML8xxxLZ/tools/cmake_toolchain_files/armgcc.cmake" -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=release  .
